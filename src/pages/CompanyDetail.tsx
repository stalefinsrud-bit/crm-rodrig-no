...
export default function CompanyDetail() {
  ...
  if (isLoading || !company) {
    return <div className="flex items-center justify-center py-20 text-muted-foreground">Loading company...</div>;
  }
        ...
        <Card className="lg:col-span-1">
          ...
          <CardContent className="space-y-3 text-sm">
            ...
            {company.fleet_size != null && (
              <InfoRow icon={Ship} label="Fleet Size" value={String(company.fleet_size)} />
            )}
